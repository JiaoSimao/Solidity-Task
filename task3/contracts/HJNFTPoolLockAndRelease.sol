...
contract HJNFTPoolLockAndRelease is CCIPReceiver, OwnerIsCreator {
        ...
        override
    {
        ...
        // require(TokenLocked[tokenId], "the token id not locked");
        //transfer token fron this address to new owner
